...
import { validateRatingsStateShape } from "./ratings.js"
import { cloneSessionSummary } from "./session-summary.js"
import {
    cloneRounds,
    cloneStringArray,
    cloneTeamRecord,
...
import { cloneBracket, cloneRemix, cloneTournamentConfig, cloneTournamentSeries } from "./tournament.js"
import { cloneOrNormalizeTournamentPhases } from "./tournament-phases.js"
...
function applyOptionalTournamentFields(source, path, next) {
    ...
    if (source.night !== undefined && source.night !== null) {
