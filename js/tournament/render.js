...
import { computeStandings, determineMatchWinner } from "./engine.js"

/**
 * Render a compact bracket overview showing past round results.
 * Appended below the current round's matches.
 */
export function renderTournamentOverview(session, container) {
 ...
 */
export function renderStandingsTable(teams, rounds, container) {
